...
#ifndef Lesson22_CLASS
#define Lesson22_CLASS
...
#define MAX_EXTENSION_LENGTH 256									// Maximum Of Characters In One Extension-Strin
...
public:
	...
	void doCube(void) {
		...
		for (i = 0; i<4; i++) {
			glTexCoord2f(datax[5 * i], datax[5 * i + 1]);
			glVertex3f(datax[5 * i + 2], datax[5 * i + 3], datax[5 * i + 4]);
		}
		// Back Face
		glNormal3f(0.0f, 0.0f, -1.0f);
		for (i = 4; i<8; i++) {
	...
	bool doMesh1TexelUnits(void) {
		...
		*/
		...
		for (i = 0; i<4; i++) {
			...
			glTexCoord2f(datax[5 * i] + c[0], datax[5 * i + 1] + c[1]);
			glVertex3f(datax[5 * i + 2], datax[5 * i + 3], datax[5 * i + 4]);
		}
		// Back Face	
		n[0] = 0.0f;		n[1] = 0.0f;		n[2] = -1.0f;
	...
	bool doMesh2TexelUnits(void) {
		...
		*/
		...
		for (i = 0; i<4; i++) {
			...
			c[2] = datax[5 * i + 4];
			SetUpBumps(n, c, l, s, t);
			glMultiTexCoord2fARB(GL_TEXTURE0_ARB, datax[5 * i], datax[5 * i + 1]);
			glMultiTexCoord2fARB(GL_TEXTURE1_ARB, datax[5 * i] + c[0], datax[5 * i + 1] + c[1]);
			glVertex3f( datax[5 * i + 2], datax[5 * i + 3], datax[5 * i + 4]);
		}
		// Back Face	
		n[0] = 0.0f;		n[1] = 0.0f;		n[2] = -1.0f;
