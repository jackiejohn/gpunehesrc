...
BOOL Initialize35(GL_Window* window, Keys* keys)					// Any GL Init Code & User Initialiazation Goes Here
{
	g_window = window;
	g_keys = keys;
...
void Deinitialize35(void)										// Any User DeInitialization Goes Here
{
	CloseAVI();													// Close The AVI File
}

void Update35(DWORD milliseconds)								// Perform Motion Updates Here
{
...
void Draw35(void)												// Draw Our Scene
{
