...
#ifndef Lesson30_CLASS
#define Lesson30_CLASS
...
public:
	...
	TVector dir = TVector(0, 0, -10);                     //initial direction of camera
	TVector pos = TVector(0, -50, 1000);                  //initial position of camera
	TVector veloc = TVector(0.5, -0.1, 0.5);              //initial velocity of balls

	TVector accel = TVector(0, -0.05, 0);                 //acceleration ie. gravity of balls
