...
public:
	...
	int InitGL(GLvoid)													// All Setup For OpenGL Goes Here
	{
		...
		LoadTexture("/Data/Art/Font.bmp", tex);								// Load the font texture
		...
		LoadTexture("/Data/Art/HardGlow2.bmp", gCamera.m_GlowTexture);
		...
		LoadTexture("/Data/Art/BigGlow3.bmp", gCamera.m_BigGlowTexture);
		...
		LoadTexture("/Data/Art/Halo3.bmp", gCamera.m_HaloTexture);
		...
		LoadTexture("/Data/Art/Streaks4.bmp", gCamera.m_StreakTexture);
