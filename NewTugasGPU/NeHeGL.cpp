	...
	int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
	{
		...
		while (g_isProgramLooping)											// Loop Until WM_QUIT Is Received
		{
			...
			if (CreateWindowGL(&window) == TRUE)							// Was Window Creation Successful?
			{
				...
				{
				case 32:
					init = Initialize(&window, &keys);
					break;
				case 35:
					init = Initialize35(&window, &keys);
						break;
				case 36:
					init = Initialize36(&window, &keys);
					break;
				case 37:
					init = Initialize37(&window, &keys);
					break;
				case 38:
					init = Initialize38(&window, &keys);
					break;
				case 39:
					init = Initialize39(&window, &keys);
					break;
				case 40:
					init = Initialize40(&window, &keys);
					break;
				case 41:
					init = Initialize41(&window, &keys);
					break;
				case 42:
					init = Initialize42(&window, &keys);
				case 45:
					init = Initialize45(&window, &keys);
					break;
				case 46:
					init = Initialize46(&window, &keys);
					break;
				case 47:
					init = Initialize46(&window, &keys);
					break;
				case 48:
					init = Initialize48(&window, &keys);
					break;
				default:
					break;
				}
						...
						else												// If There Are No Messages
						{
							...
							else											// If Window Is Visible
							{
								...
								case 35:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update35(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw35();
									break;
								case 36:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update36(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw36();
									break;
								case 37:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update37(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw37();
									break;
								case 38:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update38(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw38();
									break;
								case 39:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update39(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw39();
									break;
								case 40:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update40(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw40();
									break;
								case 41:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update41(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw41();
									break;
								case 42:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update42(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw42();
									break;
								case 45:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update45(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw45();
									break;
									break;
								case 46:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update46(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw46();
									break;
									break;
								case 47:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update47(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw47();
									break;
								case 48:
									// Process Application Loop
									tickCount = GetTickCount();				// Get The Tick Count
									Update48(tickCount - window.lastTickCount);	// Update The Counter
									window.lastTickCount = tickCount;			// Set Last Count To Current Count
									Draw48();
									break;
								default:
