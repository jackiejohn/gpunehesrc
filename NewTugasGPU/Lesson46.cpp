...
BOOL Initialize46(GL_Window* window, Keys* keys)					// Any GL Init Code & User Initialiazation Goes Here
{
	g_window = window;
	g_keys = keys;
...
void Deinitialize46(void)										// Any User DeInitialization Goes Here
{
}

void Update46(DWORD milliseconds)								// Perform Motion Updates Here
{
	// ROACH
...
void Draw46(void)												// Draw The Scene
{
	// ROACH
	if (domulti)
